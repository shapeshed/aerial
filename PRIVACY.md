...
- App preferences, such as list or grid view
...
Aerial can export your stations, settings, and local station logos to a zip file
when you choose to use the export feature. The file is created only when you
...
Aerial does not send your saved station list, favorites, settings, or backup
