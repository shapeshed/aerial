...
internal fun recoverLogoPath(storedPath: String, remoteLogoUrl: String, fileExists: Boolean): String = when {
...
internal fun recentlyPlayedLogoPath(storedPath: String, remoteLogoUrl: String): String = recoverLogoPath(
